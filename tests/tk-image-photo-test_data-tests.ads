...
package Tk.Image.Photo.Test_Data.Tests is
   ...
   --  tk-image-photo.ads:310:4:Get_Option:Tests_Get_Option_Photo

   procedure Test_Copy_0a35cf_21de2d(Gnattest_T: in out Test);
   --  tk-image-photo.ads:390:4:Copy:Tests_Copy_Photo

   procedure Test_Get_Data_433b25_8ba84f(Gnattest_T: in out Test);
   --  tk-image-photo.ads:430:4:Get_Data:Tests_Get_Data_Photo

   procedure Test_Get_Color_6fd571_5f6b3a(Gnattest_T: in out Test);
   --  tk-image-photo.ads:460:4:Get_Color:Tests_Get_Color_Photo

   procedure Test_Put_Data_cd9739_ee5695(Gnattest_T: in out Test);
   --  tk-image-photo.ads:488:4:Put_Data:Tests_Put_Data_Photo

   procedure Test_Read_95a1fe_24b510(Gnattest_T: in out Test);
   --  tk-image-photo.ads:527:4:Read:Tests_Read_Photo

   procedure Test_Redither_68a59f_4f3041(Gnattest_T: in out Test);
   --  tk-image-photo.ads:554:4:Redither:Tests_Redither_Photo

   procedure Test_Get_Transparency_745b2d_ffe137(Gnattest_T: in out Test);
   --  tk-image-photo.ads:586:4:Get_Transparency:Tests_Get_Transparency_Photo

   procedure Test_Set_Transparency_76d5d1_e76ade(Gnattest_T: in out Test);
   --  tk-image-photo.ads:617:4:Set_Transparency:Tests_Set_Transparency_Photo

   procedure Test_Write_a9d740_96f97b(Gnattest_T: in out Test);
   --  tk-image-photo.ads:652:4:Write:Tests_Write_Photo

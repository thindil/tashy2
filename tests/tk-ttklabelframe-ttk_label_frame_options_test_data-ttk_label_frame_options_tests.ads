...
is
   ...
   procedure Test_Create_32e405_815235
     (Gnattest_T: in out Test_Ttk_Label_Frame_Options);
   --  tk-ttklabelframe.ads:113:4:Create:Test_Create_TtkLabelFrame1

   procedure Test_Create_ebbdc1_897460
     (Gnattest_T: in out Test_Ttk_Label_Frame_Options);
   --  tk-ttklabelframe.ads:146:4:Create:Test_Create_TtkLabelFrame2

   procedure Test_Get_Options_ded36e_8eedcd
     (Gnattest_T: in out Test_Ttk_Label_Frame_Options);
   --  tk-ttklabelframe.ads:171:4:Get_Options:Test_Get_Options_TtkLabelFrame

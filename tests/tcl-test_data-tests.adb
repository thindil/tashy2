...
--  end read only
--  begin read only
   procedure Wrap_Test_Tcl_Eval_6f41cd_5b9cd5 (Tcl_Script: String; Interpreter: Tcl_Interpreter := Get_Interpreter) 
   is
   begin
      begin
         pragma Assert
      ...
      GNATtest_Generated.GNATtest_Standard.Tcl.Tcl_Eval (Tcl_Script, Interpreter);
      begin
         pragma Assert
           (True);
         null;
...
--  begin read only
   ...
   procedure Test_Tcl_Eval_6f41cd_5b9cd5 (Gnattest_T : in out Test) renames Test_1_Tcl_Eval_test_tcl_eval;
--  id:2.2/6f41cdb0dd725e03/Tcl_Eval/1/0/test_tcl_eval/
   procedure Test_1_Tcl_Eval_test_tcl_eval (Gnattest_T : in out Test) is
   procedure Tcl_Eval (Tcl_Script: String; Interpreter: Tcl_Interpreter := Get_Interpreter) renames Wrap_Test_Tcl_Eval_6f41cd_5b9cd5;
--  end read only
...
--  begin read only
   function Wrap_Test_Tcl_Eval_907c70_916b02 (Tcl_Script: String; Interpreter: Tcl_Interpreter := Get_Interpreter)  return String
   is
   begin
      begin
         pragma Assert
      ...
      declare
         Test_Tcl_Eval_907c70_916b02_Result : constant String := GNATtest_Generated.GNATtest_Standard.Tcl.Tcl_Eval (Tcl_Script, Interpreter);
      begin
         begin
            pragma Assert
              (True);
...
--  begin read only
   ...
   procedure Test_Tcl_Eval_907c70_916b02 (Gnattest_T : in out Test) renames Test_2_Tcl_Eval_test_tcl_eval2;
--  id:2.2/907c70df81e5b2fb/Tcl_Eval/0/0/test_tcl_eval2/
   procedure Test_2_Tcl_Eval_test_tcl_eval2 (Gnattest_T : in out Test) is
      function Tcl_Eval (Tcl_Script: String; Interpreter: Tcl_Interpreter := Get_Interpreter) return String renames Wrap_Test_Tcl_Eval_907c70_916b02;
--  end read only
...
--  begin read only
   function Wrap_Test_Tcl_Eval_8c4419_19bef1 (Tcl_Script: String; Interpreter: Tcl_Interpreter := Get_Interpreter)  return Boolean
   is
   begin
      begin
         pragma Assert
      ...
      declare
         Test_Tcl_Eval_8c4419_19bef1_Result : constant Boolean := GNATtest_Generated.GNATtest_Standard.Tcl.Tcl_Eval (Tcl_Script, Interpreter);
      begin
         begin
            pragma Assert
              (True);
...
--  begin read only
   ...
   procedure Test_Tcl_Eval_8c4419_19bef1 (Gnattest_T : in out Test) renames Test_3_Tcl_Eval_test_tcl_eval3;
--  id:2.2/8c4419ae7fa247fc/Tcl_Eval/0/0/test_tcl_eval3/
   procedure Test_3_Tcl_Eval_test_tcl_eval3 (Gnattest_T : in out Test) is
      function Tcl_Eval (Tcl_Script: String; Interpreter: Tcl_Interpreter := Get_Interpreter) return Boolean renames Wrap_Test_Tcl_Eval_8c4419_19bef1;
--  end read only
...
--  begin read only
   function Wrap_Test_Tcl_Get_Result_9a7ac3_b83d43 (Interpreter: Tcl_Interpreter := Get_Interpreter)  return String
   is
   begin
      begin
         pragma Assert
      ...
      declare
         Test_Tcl_Get_Result_9a7ac3_b83d43_Result : constant String := GNATtest_Generated.GNATtest_Standard.Tcl.Tcl_Get_Result (Interpreter);
      begin
         begin
            pragma Assert
              (True);
...
--  begin read only
   ...
   procedure Test_Tcl_Get_Result_9a7ac3_b83d43 (Gnattest_T : in out Test) renames Test_Tcl_Get_Result_test_tcl_getresult;
--  id:2.2/9a7ac36b6f9d677a/Tcl_Get_Result/1/0/test_tcl_getresult/
   procedure Test_Tcl_Get_Result_test_tcl_getresult (Gnattest_T : in out Test) is
      function Tcl_Get_Result (Interpreter: Tcl_Interpreter := Get_Interpreter) return String renames Wrap_Test_Tcl_Get_Result_9a7ac3_b83d43;
--  end read only
...
--  begin read only
   procedure Wrap_Test_Tcl_Set_Result_2e8975_cb8f85 (Tcl_Result: String; Result_Type: Result_Types := Default_Result_Type; Interpreter: Tcl_Interpreter := Get_Interpreter) 
   is
   begin
      begin
         pragma Assert
      ...
      GNATtest_Generated.GNATtest_Standard.Tcl.Tcl_Set_Result (Tcl_Result, Result_Type, Interpreter);
      begin
         pragma Assert
           (True);
         null;
...
--  begin read only
   ...
   procedure Test_Tcl_Set_Result_2e8975_cb8f85 (Gnattest_T : in out Test) renames Test_Tcl_Set_Result_test_tcl_setresult;
--  id:2.2/2e8975e68b3f48df/Tcl_Set_Result/1/0/test_tcl_setresult/
   ...
   procedure Tcl_Set_Result (Tcl_Result: String; Result_Type: Result_Types := Default_Result_Type; Interpreter: Tcl_Interpreter := Get_Interpreter) renames Wrap_Test_Tcl_Set_Result_2e8975_cb8f85;
--  end read only
...
--  begin read only
   procedure Wrap_Test_Tcl_Update_7113e2_953c64 (Interpreter: Tcl_Interpreter := Get_Interpreter; Idle_Tasks_Only: Boolean := False) 
   is
   begin
      begin
         pragma Assert
      ...
      GNATtest_Generated.GNATtest_Standard.Tcl.Tcl_Update (Interpreter, Idle_Tasks_Only);
      begin
         pragma Assert
           (True);
         null;
...
--  begin read only
   ...
   procedure Test_Tcl_Update_7113e2_953c64 (Gnattest_T : in out Test) renames Test_Tcl_Update_test_tcl_update;
--  id:2.2/7113e27f42b016a5/Tcl_Update/1/0/test_tcl_update/
   ...
   procedure Tcl_Update (Interpreter: Tcl_Interpreter := Get_Interpreter; Idle_Tasks_Only: Boolean := False) renames Wrap_Test_Tcl_Update_7113e2_953c64;
--  end read only

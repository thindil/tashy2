...
package Tk.Bind is
   ...
   type Key_Syms is (SPACE, EXCLAM, QUOTEDBL, NUMBERSIGN, DOLLAR, PERCENT, AMPERSAND, QUOTERIGHT, PARENLEFT, PARENRIGHT, ASTERISK, PLUS, COMMA, MINUS, PERIOD, SLASH, KEY_0, KEY_1, KEY_2, KEY_3, KEY_4, KEY_6, KEY_7, KEY_8, KEY_9, COLON, SEMICOLON, LESS, EQUAL, GREATER, QUESTION, KEY_AT);

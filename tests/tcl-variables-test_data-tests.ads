...
package Tcl.Variables.Test_Data.Tests is
   ...
   type Test is new GNATtest_Generated.GNATtest_Standard.Tcl.Variables.Test_Data.Test
   with null record;

   procedure Test_Tcl_Set_Var_524f28_572e53 (Gnattest_T : in out Test);
   --  tcl-variables.ads:93:4:Tcl_Set_Var:Test_Tcl_SetVar

   procedure Test_Tcl_Set_Var2_256ebf_e29f6c (Gnattest_T : in out Test);
   --  tcl-variables.ads:121:4:Tcl_Set_Var2:Test_Tcl_SetVar2

   procedure Test_Tcl_Get_Var_ea64a1_45f6e9 (Gnattest_T : in out Test);
   --  tcl-variables.ads:150:4:Tcl_Get_Var:Test_Tcl_GetVar

   procedure Test_Tcl_Get_Var2_430f71_601542 (Gnattest_T : in out Test);
   --  tcl-variables.ads:239:4:Tcl_Get_Var2:Test_Tcl_GetVar2

   procedure Test_Tcl_Unset_Var_044aaf_5d27f9 (Gnattest_T : in out Test);
   --  tcl-variables.ads:330:4:Tcl_Unset_Var:Test_Tcl_UnsetVar

   procedure Test_Tcl_Unset_Var2_e9c900_618eb3 (Gnattest_T : in out Test);
   --  tcl-variables.ads:357:4:Tcl_Unset_Var2:Test_Tcl_UnsetVar2

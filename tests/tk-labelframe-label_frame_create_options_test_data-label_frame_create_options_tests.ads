...
is
   ...
   --  tk-labelframe.ads:145:4:Create:Test_Create_Label_Frame1

   procedure Test_Create_ebbdc1_5d5480
     (Gnattest_T: in out Test_Label_Frame_Create_Options);
   --  tk-labelframe.ads:179:4:Create:Test_Create_Label_Frame2

   procedure Test_Get_Options_ded36e_d97566
     (Gnattest_T: in out Test_Label_Frame_Create_Options);
   --  tk-labelframe.ads:204:4:Get_Options:Test_Get_Options_Label_Frame

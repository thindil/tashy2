...
package Tk.TtkWidget.Test_Data.Tests is
   ...
   --  tk-ttkwidget.ads:223:4:Option_Image:Test_Option_Image_Compound_Type

   procedure Test_Option_Image_5ac754_8ca289(Gnattest_T: in out Test);
   --  tk-ttkwidget.ads:229:4:Option_Image:Test_Option_Image_Distabled_State_Type

   procedure Test_Option_Image_a0749a_9522a2(Gnattest_T: in out Test);
   --  tk-ttkwidget.ads:235:4:Option_Image:Test_Option_Image_Image_Option

   procedure Test_Option_Image_fac0b4_5f511f(Gnattest_T: in out Test);
   --  tk-ttkwidget.ads:240:4:Option_Image:Test_Option_Image_Padding_Data

   procedure Test_Option_Value_5bd68b_a92add(Gnattest_T: in out Test);
   --  tk-ttkwidget.ads:263:4:Option_Value:Test_Option_Value_Compound_Type

   procedure Test_Option_Value_e44442_1318d9(Gnattest_T: in out Test);
   --  tk-ttkwidget.ads:268:4:Option_Value:Test_Option_Value_Disabled_State_Type

   procedure Test_Option_Value_7d1d95_d2d94b(Gnattest_T: in out Test);
   --  tk-ttkwidget.ads:273:4:Option_Value:Test_Option_Value_Ttk_Image_Option

   procedure Test_Option_Value_08ea7f_956d9f(Gnattest_T: in out Test);
   --  tk-ttkwidget.ads:278:4:Option_Value:Test_Option_Value_Padding_Data

   procedure Test_In_State_46b68b_db2848(Gnattest_T: in out Test);
   --  tk-ttkwidget.ads:303:4:In_State:Test_Ttk_Widget_In_State

...
package Tk.Image.Photo.Test_Data.Tests is
   ...
   --  tk-image-photo.ads:275:4:Blank:Tests_Blank_Photo

   procedure Test_Get_Option_e3d52c_8f9fe9(Gnattest_T: in out Test);
   --  tk-image-photo.ads:330:4:Get_Option:Tests_Get_Option_Photo

   procedure Test_Copy_0a35cf_21de2d(Gnattest_T: in out Test);
   --  tk-image-photo.ads:410:4:Copy:Tests_Copy_Photo

   procedure Test_Get_Data_433b25_8ba84f(Gnattest_T: in out Test);
   --  tk-image-photo.ads:450:4:Get_Data:Tests_Get_Data_Photo

   procedure Test_Get_Color_6fd571_5f6b3a(Gnattest_T: in out Test);
   --  tk-image-photo.ads:480:4:Get_Color:Tests_Get_Color_Photo

   procedure Test_Put_Data_cd9739_ee5695(Gnattest_T: in out Test);
   --  tk-image-photo.ads:508:4:Put_Data:Tests_Put_Data_Photo

   procedure Test_Read_95a1fe_24b510(Gnattest_T: in out Test);
   --  tk-image-photo.ads:547:4:Read:Tests_Read_Photo
   ...
   --  tk-image-photo.ads:637:4:Set_Transparency:Tests_Set_Transparency_Photo

   procedure Test_Write_a9d740_96f97b(Gnattest_T: in out Test);
   --  tk-image-photo.ads:672:4:Write:Tests_Write_Photo

...
--  end read only
--  begin read only
   procedure Wrap_Test_Tcl_Set_Var_524f28_572e53 (Var_Name, New_Value: String; Interpreter: Tcl_Interpreter := Get_Interpreter; Flags: Flags_Array := Default_Flags_Array) 
   is
   begin
      begin
         pragma Assert
           (Var_Name'Length > 0 and New_Value'Length > 0);
         null;
      exception
      ...
      GNATtest_Generated.GNATtest_Standard.Tcl.Variables.Tcl_Set_Var (Var_Name, New_Value, Interpreter, Flags);
      begin
         pragma Assert
           (True);
         null;
...
--  begin read only
   ...
   procedure Test_Tcl_Set_Var_524f28_572e53 (Gnattest_T : in out Test) renames Test_Tcl_Set_Var_test_tcl_setvar;
--  id:2.2/524f28d8df9078d6/Tcl_Set_Var/1/0/test_tcl_setvar/
   ...
   procedure Tcl_Set_Var (Var_Name, New_Value: String; Interpreter: Tcl_Interpreter := Get_Interpreter; Flags: Flags_Array := Default_Flags_Array) renames Wrap_Test_Tcl_Set_Var_524f28_572e53;
--  end read only
...
--  begin read only
   procedure Wrap_Test_Tcl_Set_Var2_256ebf_e29f6c (Array_Name, Index_Name, New_Value: String; Interpreter: Tcl_Interpreter := Get_Interpreter; Flags: Flags_Array := Default_Flags_Array) 
   is
   begin
      begin
         pragma Assert
           (Array_Name'Length > 0 and Index_Name'Length > 0 and New_Value'Length > 0);
         null;
      exception
         when System.Assertions.Assert_Failure =>
            AUnit.Assertions.Assert
      ...
      GNATtest_Generated.GNATtest_Standard.Tcl.Variables.Tcl_Set_Var2 (Array_Name, Index_Name, New_Value, Interpreter, Flags);
      begin
         pragma Assert
           (True);
         null;
...
--  begin read only
   ...
   procedure Test_Tcl_Set_Var2_256ebf_e29f6c (Gnattest_T : in out Test) renames Test_Tcl_Set_Var2_test_tcl_setvar2;
--  id:2.2/256ebf8f1093c92d/Tcl_Set_Var2/1/0/test_tcl_setvar2/
   ...
   procedure Tcl_Set_Var2 (Array_Name, Index_Name, New_Value: String; Interpreter: Tcl_Interpreter := Get_Interpreter; Flags: Flags_Array := Default_Flags_Array) renames Wrap_Test_Tcl_Set_Var2_256ebf_e29f6c;
--  end read only
...
--  begin read only
   function Wrap_Test_Tcl_Get_Var_ea64a1_45f6e9 (Var_Name: String; Interpreter: Tcl_Interpreter := Get_Interpreter; Flags: Flags_Array := Default_Flags_Array)  return String
   is
   begin
      begin
         pragma Assert
      ...
      declare
         Test_Tcl_Get_Var_ea64a1_45f6e9_Result : constant String := GNATtest_Generated.GNATtest_Standard.Tcl.Variables.Tcl_Get_Var (Var_Name, Interpreter, Flags);
      begin
         begin
            pragma Assert
              (True);
...
--  begin read only
   ...
   procedure Test_Tcl_Get_Var_ea64a1_45f6e9 (Gnattest_T : in out Test) renames Test_Tcl_Get_Var_test_tcl_getvar;
--  id:2.2/ea64a1eac88b0f53/Tcl_Get_Var/1/0/test_tcl_getvar/
   procedure Test_Tcl_Get_Var_test_tcl_getvar (Gnattest_T : in out Test) is
      function Tcl_Get_Var (Var_Name: String; Interpreter: Tcl_Interpreter := Get_Interpreter; Flags: Flags_Array := Default_Flags_Array) return String renames Wrap_Test_Tcl_Get_Var_ea64a1_45f6e9;
--  end read only
...
--  begin read only
   function Wrap_Test_Tcl_Get_Var2_430f71_601542 (Var_Name, Index_Name: String; Interpreter: Tcl_Interpreter := Get_Interpreter; Flags: Flags_Array := Default_Flags_Array)  return String
   is
   begin
      begin
         pragma Assert
           (Var_Name'Length > 0 and Index_Name'Length > 0 and Interpreter /= Null_Interpreter);
         null;
      exception
            when System.Assertions.Assert_Failure =>
               AUnit.Assertions.Assert
      ...
      declare
         Test_Tcl_Get_Var2_430f71_601542_Result : constant String := GNATtest_Generated.GNATtest_Standard.Tcl.Variables.Tcl_Get_Var2 (Var_Name, Index_Name, Interpreter, Flags);
      begin
         begin
            pragma Assert
              (True);
...
--  begin read only
   ...
   procedure Test_Tcl_Get_Var2_430f71_601542 (Gnattest_T : in out Test) renames Test_Tcl_Get_Var2_test_tcl_getvar2;
--  id:2.2/430f716d685a4a85/Tcl_Get_Var2/1/0/test_tcl_getvar2/
   procedure Test_Tcl_Get_Var2_test_tcl_getvar2 (Gnattest_T : in out Test) is
      function Tcl_Get_Var2 (Var_Name, Index_Name: String; Interpreter: Tcl_Interpreter := Get_Interpreter; Flags: Flags_Array := Default_Flags_Array) return String renames Wrap_Test_Tcl_Get_Var2_430f71_601542;
--  end read only
...
--  begin read only
   procedure Wrap_Test_Tcl_Unset_Var_044aaf_5d27f9 (Var_Name: String; Interpreter: Tcl_Interpreter := Get_Interpreter; Flags: Flags_Array := Default_Flags_Array) 
   is
   begin
      begin
         pragma Assert
      ...
      GNATtest_Generated.GNATtest_Standard.Tcl.Variables.Tcl_Unset_Var (Var_Name, Interpreter, Flags);
      begin
         pragma Assert
           (True);
         null;
...
--  begin read only
   ...
   procedure Test_Tcl_Unset_Var_044aaf_5d27f9 (Gnattest_T : in out Test) renames Test_Tcl_Unset_Var_test_tcl_unsetvar;
--  id:2.2/044aaf01104381e8/Tcl_Unset_Var/1/0/test_tcl_unsetvar/
   ...
   procedure Tcl_Unset_Var (Var_Name: String; Interpreter: Tcl_Interpreter := Get_Interpreter; Flags: Flags_Array := Default_Flags_Array) renames Wrap_Test_Tcl_Unset_Var_044aaf_5d27f9;
--  end read only
...
--  begin read only
   procedure Wrap_Test_Tcl_Unset_Var2_e9c900_618eb3 (Var_Name, Index_Name: String; Interpreter: Tcl_Interpreter := Get_Interpreter; Flags: Flags_Array := Default_Flags_Array) 
   is
   begin
      begin
         pragma Assert
      ...
      GNATtest_Generated.GNATtest_Standard.Tcl.Variables.Tcl_Unset_Var2 (Var_Name, Index_Name, Interpreter, Flags);
      begin
         pragma Assert
           (True);
         null;
...
--  begin read only
   ...
   procedure Test_Tcl_Unset_Var2_e9c900_618eb3 (Gnattest_T : in out Test) renames Test_Tcl_Unset_Var2_test_tcl_unsetvar2;
--  id:2.2/e9c900ac386cc122/Tcl_Unset_Var2/1/0/test_tcl_unsetvar2/
   ...
   procedure Tcl_Unset_Var2 (Var_Name, Index_Name: String; Interpreter: Tcl_Interpreter := Get_Interpreter; Flags: Flags_Array := Default_Flags_Array) renames Wrap_Test_Tcl_Unset_Var2_e9c900_618eb3;
--  end read only

...
package Tk.TtkButton.Ttk_Button_Options_Test_Data.Ttk_Button_Options_Tests is
   ...
   --  tk-ttkbutton.ads:89:4:Options_To_String:Test_Options_To_String

   procedure Test_Create_32e405_20d159
     (Gnattest_T: in out Test_Ttk_Button_Options);
   --  tk-ttkbutton.ads:115:4:Create:Test_Create_TtkButton1

   procedure Test_Create_ebbdc1_5157ad
     (Gnattest_T: in out Test_Ttk_Button_Options);
   --  tk-ttkbutton.ads:154:4:Create:Test_Create_TtkButton2

   procedure Test_Get_Options_ded36e_15baa7
     (Gnattest_T: in out Test_Ttk_Button_Options);
   --  tk-ttkbutton.ads:184:4:Get_Options:Test_Get_Options_TtkButton

   procedure Test_Configure_0076be_566320
     (Gnattest_T: in out Test_Ttk_Button_Options);
   --  tk-ttkbutton.ads:205:4:Configure:Test_Configure_TtkButton

...
package Tk.TtkLabel.Ttk_Label_Options_Test_Data.Ttk_Label_Options_Tests is
   ...
   --  tk-ttklabel.ads:103:4:Options_To_String:Test_Options_To_String

   procedure Test_Create_32e405_895b32
     (Gnattest_T: in out Test_Ttk_Label_Options);
   --  tk-ttklabel.ads:129:4:Create:Test_Create_TtkLabel1

   procedure Test_Create_ebbdc1_3cc244
     (Gnattest_T: in out Test_Ttk_Label_Options);
   --  tk-ttklabel.ads:168:4:Create:Test_Create_TtkLabel2

   procedure Test_Get_Options_ded36e_523496
     (Gnattest_T: in out Test_Ttk_Label_Options);
   --  tk-ttklabel.ads:198:4:Get_Options:Test_Get_Options_TtkLabel

   procedure Test_Configure_0076be_ea215f
     (Gnattest_T: in out Test_Ttk_Label_Options);
   --  tk-ttklabel.ads:219:4:Configure:Test_Configure_TtkLabel

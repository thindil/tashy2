...
--  begin read only
   ...
   begin
      ...
      begin
         ...
         return Test_Create_32e405_997ec9_Result;
      end;
   end Wrap_Test_Create_32e405_997ec9;
--  end read only
...
--  begin read only
   ...
   end Wrap_Test_Create_ebbdc1_5d5480;
--  end read only
...
--  begin read only
   ...
   begin
      ...
      begin
         ...
         return Test_Get_Options_ded36e_d97566_Result;
      end;
   end Wrap_Test_Get_Options_ded36e_d97566;
--  end read only

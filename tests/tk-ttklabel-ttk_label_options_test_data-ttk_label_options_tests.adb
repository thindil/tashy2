...
--  begin read only
   function Wrap_Test_Options_To_String_0a74e5_498c45
     (Options: Ttk_Label_Options) return String is
   begin
      declare
         Test_Options_To_String_0a74e5_498c45_Result: constant String :=
           GNATtest_Generated.GNATtest_Standard.Tk.TtkLabel.Options_To_String
             (Options);
      begin
   ...
   procedure Test_Options_To_String_test_options_to_string
     (Gnattest_T: in out Test_Ttk_Label_Options) is
      function Options_To_String
        (Options: Ttk_Label_Options) return String renames
...
--  end read only
   ...
   begin
      ...
      Assert
        (Options_To_String(Ttk_Label_Options'(others => <>)) = "",
         "Failed to convert default Ttk_Label_Options to Tcl command.");
      Assert
        (Options_To_String
           (Ttk_Label_Options'(Relief => RAISED, others => <>)) =
         " -relief raised",
         "Failed to convert Ttk_Label_Options to Tcl command.");

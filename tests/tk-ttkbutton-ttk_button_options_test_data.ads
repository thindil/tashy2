...
package Tk.TtkButton.Ttk_Button_Options_Test_Data is
...
--  end read only
   ...
   procedure Set_Up(Gnattest_T: in out Test_Ttk_Button_Options);
   procedure Tear_Down(Gnattest_T: in out Test_Ttk_Button_Options);

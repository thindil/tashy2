...
package Tcl.Info.Test_Data.Tests is
   ...
   --  tcl-info.ads:43:4:Get_Arguments:Test_Info_Arguments

   procedure Test_Get_Procedure_Body_4ab4c1_bdefa7(Gnattest_T: in out Test);
   --  tcl-info.ads:76:4:Get_Procedure_Body:Test_Info_Procedure_Body

   procedure Test_Get_Commands_Count_9e53d6_cae496(Gnattest_T: in out Test);
   --  tcl-info.ads:105:4:Get_Commands_Count:Test_Info_Commands_Count

   procedure Test_Get_Commands_f2ad9c_3093bd(Gnattest_T: in out Test);
   --  tcl-info.ads:131:4:Get_Commands:Test_Info_Command

   procedure Test_Complete_c39017_214fb5(Gnattest_T: in out Test);
   --  tcl-info.ads:164:4:Complete:Test_Info_Complete

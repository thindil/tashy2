...
-- ****
   ...
   function Option_Value
     (Widgt: Tk_Widget; Name: Variable_Name) return Directions_Type with
      ...
      Test_Case => (Name => "Test_Option_Value_Direction_Type",
       Mode => Nominal);
   function Option_Value
     (Widgt: Tk_Widget; Name: Variable_Name) return Pixel_Data with
      Global => null,
      Pre => Widgt /= Null_Widget and Name_Is_Valid(Name => Name),
      Test_Case => (Name => "Test_Option_Value_Pixel_Data", Mode => Nominal);
   function Option_Value
     (Widgt: Tk_Widget; Name: Variable_Name) return Place_Type with
      Global => null,
      Pre => Widgt /= Null_Widget and Name_Is_Valid(Name => Name),
   ...
   function Option_Value
     (Widgt: Tk_Widget; Name: Variable_Name) return Justify_Type with
      Global => null,
      Pre => Widgt /= Null_Widget and Name_Is_Valid(Name => Name),
   ...
   function Option_Value
     (Widgt: Tk_Widget; Name: Variable_Name) return Extended_Natural with
      Global => null,
      Pre => Widgt /= Null_Widget and Name_Is_Valid(Name => Name),
   ...
   function Option_Value
     (Widgt: Tk_Widget; Name: Variable_Name) return Extended_Boolean with
      ...
      Test_Case => (Name => "Test_Option_Value_Extended_Boolean",
       Mode => Nominal);
   function Option_Value
     (Widgt: Tk_Widget; Name: Variable_Name) return Tk_Widget with
      Global => null,
      Pre => Widgt /= Null_Widget and Name_Is_Valid(Name => Name),
      Test_Case => (Name => "Test_Option_Value_Tk_Widget", Mode => Nominal);
   function Option_Value
     (Widgt: Tk_Widget; Name: Variable_Name) return Tk_Window with
      Global => null,
      Pre => Widgt /= Null_Widget and Name_Is_Valid(Name => Name),
      Test_Case => (Name => "Test_Option_Value_Tk_Window", Mode => Nominal);
   function Option_Value
     (Widgt: Tk_Widget; Name: Variable_Name) return Integer with
      Global => null,
      Pre => Widgt /= Null_Widget and Name_Is_Valid(Name => Name),
   ...
   function Option_Value
     (Widgt: Tk_Widget; Name: Variable_Name) return Anchor_Directions with
      ...
      Test_Case => (Name => "Test_Option_Value_Anchor_Directions",
       Mode => Nominal);
   function Option_Value
     (Widgt: Tk_Widget; Name: Variable_Name) return Color_Type with
      Pre => Widgt /= Null_Widget and Name_Is_Valid(Name => Name),

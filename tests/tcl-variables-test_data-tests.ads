...
package Tcl.Variables.Test_Data.Tests is
   ...
   --  tcl-variables.ads:97:4:Tcl_Set_Var:Test_Tcl_SetVar

   procedure Test_Tcl_Set_Var2_256ebf_e29f6c(Gnattest_T: in out Test);
   --  tcl-variables.ads:125:4:Tcl_Set_Var2:Test_Tcl_SetVar2

   procedure Test_Tcl_Get_Var_ea64a1_45f6e9(Gnattest_T: in out Test);
   --  tcl-variables.ads:153:4:Tcl_Get_Var:Test_Tcl_GetVar
   ...
   --  tcl-variables.ads:329:4:Tcl_Unset_Var:Test_Tcl_UnsetVar

   procedure Test_Tcl_Unset_Var2_e9c900_618eb3(Gnattest_T: in out Test);
   --  tcl-variables.ads:355:4:Tcl_Unset_Var2:Test_Tcl_UnsetVar2

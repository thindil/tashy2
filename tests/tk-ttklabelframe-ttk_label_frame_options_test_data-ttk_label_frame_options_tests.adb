...
--  begin read only
   function Wrap_Test_Options_To_String_0a74e5_498c45
     (Options: Ttk_Label_Frame_Options) return String is
   begin
      declare
         Test_Options_To_String_0a74e5_498c45_Result: constant String :=
           GNATtest_Generated.GNATtest_Standard.Tk.TtkLabelFrame
             .Options_To_String
             (Options);
      begin
   ...
   procedure Test_Options_To_String_test_options_to_string
     (Gnattest_T: in out Test_Ttk_Label_Frame_Options) is
      function Options_To_String
        (Options: Ttk_Label_Frame_Options) return String renames
...
--  end read only
   ...
   begin
      ...
      Assert
        (Options_To_String(Ttk_Label_Frame_Options'(others => <>)) = "",
         "Failed to convert default Ttk_Label_Frame_Options to Tcl command.");
      Assert
        (Options_To_String
           (Ttk_Label_Frame_Options'
              (Text => To_Tcl_String("My frame"), others => <>)) =
         " -text {My frame}",
         "Failed to convert Ttk_Label_Frame_Options to Tcl command.");
...
--  begin read only
   function Wrap_Test_Create_32e405_76663d
   ...
   begin
      ...
      declare
         Test_Create_32e405_76663d_Result: constant Ttk_Label_Frame :=
      ...
      begin
         ...
         return Test_Create_32e405_76663d_Result;
      end;
   end Wrap_Test_Create_32e405_76663d;
--  end read only
   ...
   procedure Test_1_Create_test_create_ttklabelframe1
     (Gnattest_T: in out Test_Ttk_Label_Frame_Options) is
      function Create
        ...
        Wrap_Test_Create_32e405_76663d;
--  end read only
...
--  begin read only
   procedure Wrap_Test_Create_ebbdc1_92306c
   ...
   end Wrap_Test_Create_ebbdc1_92306c;
--  end read only
   ...
   procedure Test_2_Create_test_create_ttklabelframe2
     (Gnattest_T: in out Test_Ttk_Label_Frame_Options) is
      procedure Create
        ...
        Wrap_Test_Create_ebbdc1_92306c;
--  end read only

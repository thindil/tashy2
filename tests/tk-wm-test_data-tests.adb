...
--  begin read only
   function Wrap_Test_Get_Attribute_942835_ed7f72
   ...
   begin
      ...
      declare
         Test_Get_Attribute_942835_ed7f72_Result: constant Tcl_String :=
      ...
      begin
         ...
         return Test_Get_Attribute_942835_ed7f72_Result;
      end;
   end Wrap_Test_Get_Attribute_942835_ed7f72;
--  end read only

--  begin read only
   procedure Test_1_Get_Attribute_test_wm_get_attribute
     (Gnattest_T: in out Test);
   procedure Test_Get_Attribute_942835_ed7f72(Gnattest_T: in out Test) renames
     Test_1_Get_Attribute_test_wm_get_attribute;
--  id:2.2/9428351d9dddc4a4/Get_Attribute/1/0/test_wm_get_attribute/
   procedure Test_1_Get_Attribute_test_wm_get_attribute
     (Gnattest_T: in out Test) is
      function Get_Attribute(Window: Tk_Widget) return Tcl_String renames
        Wrap_Test_Get_Attribute_942835_ed7f72;
--  end read only
   ...
   begin
      ...
      if Window_Manager /= MACOSX then
         Assert
           (True, "This option is available only on MACOSX window manager");
         return;
      end if;
      Assert
        (Get_Attribute(Get_Main_Window) =
         Get_Attributes(Get_Main_Window).Title_Path,
...
--  begin read only
   function Wrap_Test_Get_Attribute_e0766a_69dacd
   ...
   begin
      ...
      declare
         Test_Get_Attribute_e0766a_69dacd_Result: constant Alpha_Type :=
           GNATtest_Generated.GNATtest_Standard.Tk.Wm.Get_Attribute(Window);
      begin
         begin
            pragma Assert(True);
         ...
         return Test_Get_Attribute_e0766a_69dacd_Result;
      end;
   end Wrap_Test_Get_Attribute_e0766a_69dacd;
--  end read only

--  begin read only
   procedure Test_3_Get_Attribute_test_wm_get_attribute3
     (Gnattest_T: in out Test);
   procedure Test_Get_Attribute_e0766a_69dacd(Gnattest_T: in out Test) renames
   ...
   procedure Test_3_Get_Attribute_test_wm_get_attribute3
     (Gnattest_T: in out Test) is
      function Get_Attribute(Window: Tk_Widget) return Alpha_Type renames
        Wrap_Test_Get_Attribute_e0766a_69dacd;
--  end read only
...
--  begin read only
   function Wrap_Test_Get_Attribute_6aefd8_921353
   ...
   begin
      ...
      declare
         Test_Get_Attribute_6aefd8_921353_Result: constant Window_Types :=
           GNATtest_Generated.GNATtest_Standard.Tk.Wm.Get_Attribute(Window);
      begin
         begin
            pragma Assert(True);
         ...
         return Test_Get_Attribute_6aefd8_921353_Result;
      end;
   end Wrap_Test_Get_Attribute_6aefd8_921353;
--  end read only

--  begin read only
   procedure Test_4_Get_Attribute_test_wm_get_attribute4
     (Gnattest_T: in out Test);
   procedure Test_Get_Attribute_6aefd8_921353(Gnattest_T: in out Test) renames
   ...
   procedure Test_4_Get_Attribute_test_wm_get_attribute4
     (Gnattest_T: in out Test) is
      function Get_Attribute(Window: Tk_Widget) return Window_Types renames
        Wrap_Test_Get_Attribute_6aefd8_921353;
--  end read only
...
--  begin read only
   function Wrap_Test_Get_Attribute_7d857a_382290
     (Window: Tk_Widget) return Color_Type is
   begin
      begin
         pragma Assert
           (Window /= Null_Widget and Get_Interpreter /= Null_Interpreter);
      ...
      exception
         when System.Assertions.Assert_Failure =>
            AUnit.Assertions.Assert
              (False,
               "req_sloc(tk-wm.ads:0):Test_Wm_Get_Attribute5 test requirement violated");
      end;
      declare
         Test_Get_Attribute_7d857a_382290_Result: constant Color_Type :=
           GNATtest_Generated.GNATtest_Standard.Tk.Wm.Get_Attribute(Window);
      begin
         begin
            pragma Assert(True);
         ...
         exception
            when System.Assertions.Assert_Failure =>
               AUnit.Assertions.Assert
                 (False,
                  "ens_sloc(tk-wm.ads:0:):Test_Wm_Get_Attribute5 test commitment violated");
         end;
         return Test_Get_Attribute_7d857a_382290_Result;
      end;
   end Wrap_Test_Get_Attribute_7d857a_382290;
--  end read only

--  begin read only
   procedure Test_5_Get_Attribute_test_wm_get_attribute5
     (Gnattest_T: in out Test);
   procedure Test_Get_Attribute_7d857a_382290(Gnattest_T: in out Test) renames
     Test_5_Get_Attribute_test_wm_get_attribute5;
--  id:2.2/7d857aa76faa87e8/Get_Attribute/0/0/test_wm_get_attribute5/
   procedure Test_5_Get_Attribute_test_wm_get_attribute5
     (Gnattest_T: in out Test) is
      function Get_Attribute(Window: Tk_Widget) return Color_Type renames
        Wrap_Test_Get_Attribute_7d857a_382290;
--  end read only
   ...
   begin
      ...
      Assert
        (Get_Attribute(Get_Main_Window) = Empty_Color,
         "Failed to get color type attribute for the main window");

--  begin read only
   end Test_5_Get_Attribute_test_wm_get_attribute5;
--  end read only
...
--  begin read only
   function Wrap_Test_Get_Protocol_aa44e2_c76ad7
   ...
   begin
      ...
      declare
         Test_Get_Protocol_aa44e2_c76ad7_Result: constant String :=
      ...
      begin
         ...
         return Test_Get_Protocol_aa44e2_c76ad7_Result;
      end;
   end Wrap_Test_Get_Protocol_aa44e2_c76ad7;
--  end read only

--  begin read only
   procedure Test_Get_Protocol_test_wm_protocol2(Gnattest_T: in out Test);
   procedure Test_Get_Protocol_aa44e2_c76ad7(Gnattest_T: in out Test) renames
...
--  id:2.2/aa44e237072653b7/Get_Protocol/1/0/test_wm_protocol2/
   procedure Test_Get_Protocol_test_wm_protocol2(Gnattest_T: in out Test) is
      function Get_Protocol
        ...
        Wrap_Test_Get_Protocol_aa44e2_c76ad7;
--  end read only
...
--  begin read only
   function Wrap_Test_Get_Stack_Order_Above_707d59_07f28f
   ...
   begin
      ...
      declare
         Test_Get_Stack_Order_Above_707d59_07f28f_Result: constant Tcl_Boolean_Result :=
      ...
      begin
         ...
         return Test_Get_Stack_Order_Above_707d59_07f28f_Result;
      end;
   end Wrap_Test_Get_Stack_Order_Above_707d59_07f28f;
--  end read only

--  begin read only
   procedure Test_Get_Stack_Order_Above_test_wm_stack_order2
     (Gnattest_T: in out Test);
   procedure Test_Get_Stack_Order_Above_707d59_07f28f
     (Gnattest_T: in out Test) renames
   ...
   procedure Test_Get_Stack_Order_Above_test_wm_stack_order2
     (Gnattest_T: in out Test) is
      function Get_Stack_Order_Above
        ...
        Wrap_Test_Get_Stack_Order_Above_707d59_07f28f;
--  end read only
